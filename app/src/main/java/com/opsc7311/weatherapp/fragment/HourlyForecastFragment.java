package com.opsc7311.weatherapp.fragment;
...
import com.opsc7311.weatherapp.adapter.HourlyForecastAdapter;
import com.opsc7311.weatherapp.model.HourlyForecast;
import com.opsc7311.weatherapp.util.NetworkUtil;
            ...
            if (hourlyForecastJSON != null) {
                try {
                    ...
                    for (int i = 0; i < hourlyForecast.length(); i++) {
                        ...
                        JSONObject hourlyForecastTemp = dailyWeather.getJSONObject("Temperature");
                        int temperature = hourlyForecastTemp.getInt("Value");

                        String unit = hourlyForecastTemp.getString("Unit");

                        Log.d(TAG, "consumeJson: temperature " + temperature + " " + unit);
                        forecastObject.setValue(temperature);
                        forecastObject.setUnit(unit);
